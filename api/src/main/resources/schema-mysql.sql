...
(
    ...
    is_alarm        varchar(1) default '0' null comment '알람 허용 여부 ( 1: 알림 허용 , 0 : 알림 미허용 )',
...
create index fk_scheduler_user_idx
    on scheduler (user_id);
...
(
    ...
    is_common       varchar(1) default '0' null comment '공통 공휴일( 1 : 공통 공휴일 , 0 : 특정 사용자 공휴일 )',
    user_id         int                    null,
    create_datetime datetime               null,
    modify_datetime datetime               null,
    constraint id_UNIQUE
